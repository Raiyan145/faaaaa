...
export const GameCanvas: React.FC<GameCanvasProps> = ({
  ...
  // Reset whenever a new PLAYING session begins.
  // TRY AGAIN changes GAMEOVER -> PLAYING directly, so the previous
  // obstacle array/state must be cleared before the new run starts.
  useEffect(() => {
